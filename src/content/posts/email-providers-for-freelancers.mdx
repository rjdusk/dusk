...
description: I've used various platforms over the years for email and calenders, ever since breaking up with Google. This is a comparison of several providers.

image:
  url: "../../images/journal/cover--email-providers.png"
...
<figure class="-mx-4 lg:-mx-8 bg-gray-100">
    <MDXimage alt="The OX App interface" imagePath="/src/images/journal/ox-interface.jpg" width={880} height={408} widths={[320, 640, 960]} />
    <figcaption class="bg-yellow-50 text-xs">The OX App interface</figcaption>
</figure>
